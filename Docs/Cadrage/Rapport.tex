...
\begin{titlepage}
	\centering
		...
		\vfill
		\includegraphics[width=8cm]{Logo_Preview.png} % also works with logo.pdf
		\begin{figure}[b]
			\includegraphics[width=4cm]{Logo-ESIEA.jpg} % also works with logo.pdf
