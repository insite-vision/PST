...
\newpage
	...
	Un risques est un aleas qui contreviendrait a l'atteinte de nos objectifs. Ces risques dependent bien entendu du type de projet que nous cherchons a entreprendre, et un projet de recherche pose des problematiques differentes de celles d'un projet ou l'on cherche a construire un produit. Cependant il est important de pouvoir analyser ces risques pour pouvoir tenter de les mitiger. 
\begin{table}[ht]
	\centering
	...
	\begin{tabular}{l|l|l|l|}
		\cline{2-4}
		& Importance & Probabilite & Solutions                                 \\ \hline
